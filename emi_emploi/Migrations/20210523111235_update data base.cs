...
namespace emi_emploi.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdSemaine_depart = table.Column<int>(nullable: false),
                    IdSemaine_fin = table.Column<int>(nullable: false),
                    heure_debut = table.Column<int>(nullable: false),
                    heure_fin = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Disponibilite", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ListFiliere", x => x.id);
                });
